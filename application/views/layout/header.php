...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="https://seeklogo.com/images/P/pdi-love-logo-C8738BCFAD-seeklogo.com.png?v=638198273740000000">
</head>
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item dropdown d-none d-lg-block user-dropdown">
          <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
            <img class="img-xs rounded-circle" src="<?= base_url('assets/images/profile/') . $user['gambar']; ?>" alt="Profile image"> </a>
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
            <div class="dropdown-header text-center">
              <img class="img-md rounded-circle" src="<?= base_url('assets/images/profile/') . $user['gambar']; ?>" alt="Profile image">
              <p class="mb-1 mt-3 font-weight-semibold"><?= $user['nama']; ?></p>
              <p class="fw-light text-muted mb-0"><?= $user['email']; ?></p>
            </div>
            <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> My
              Profile <span class="badge badge-pill badge-danger">1</span></a>
            <a class="dropdown-item" href="<?= base_url('Auth/logout'); ?>"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
          </div>
        </li>
      </ul>
